...
/* ═══════════════════════════════════════════════════════════════
   SPECULAR LIGHT SWEEP (6-10 second ambient sweep)
   ═══════════════════════════════════════════════════════════════ */
...
export default function LoginView({ onLogin, onNavigateToRegister }: LoginViewProps) {
  ...
  // ── Cursor-reactive lighting for login card ──
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ════════════════════════════════════════════════════════
           RIGHT SIDE: Sign In Form (Crystal Card)
           ════════════════════════════════════════════════════════ */}
        <motion.div
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        >
          <div
            className="h-full w-full rounded-[2rem] p-6 lg:p-10 flex flex-col justify-center relative overflow-hidden"
            style={{
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
              {/* Email */}
              <div>
                <label htmlFor="login-email" className="block text-[13px] font-bold text-slate-700 mb-2">
                  Email Address
                </label>
                <div className="relative group/input">
                  ...
                  <motion.input
                    ...
                    required
                    autoComplete="email"
                    className="block w-full pl-11 pr-4 py-3 rounded-[1rem] focus:outline-none text-[14px] font-medium text-slate-900 placeholder-slate-400 transition-all duration-300 hover:border-emerald-200 hover:shadow-[0_2px_8px_rgba(16,185,129,0.06)]"
                    style={{
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    type="button"
                    className="text-[12px] font-bold text-emerald-600 hover:text-emerald-700 focus:outline-none relative group/forgot"
                    onClick={() => alert('Password reset directions dispatched.')}
                  >
                    Forgot Password?
                    <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-emerald-600 group-hover/forgot:w-full transition-all duration-300" />
                  </button>
                </div>
                <div className="relative group/input">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  ...
                  <motion.input
                    ...
                    className="block w-full pl-11 pr-11 py-3 rounded-[1rem] focus:outline-none text-[14px] font-medium text-slate-900 placeholder-slate-400 tracking-wide transition-all duration-300 hover:border-emerald-200 hover:shadow-[0_2px_8px_rgba(16,185,129,0.06)]"
                    style={{
                      background: 'linear-gradient(135deg, rgba(248,250,252,0.9), rgba(241,245,249,0.95))',
                      border: '1px solid rgba(226,232,240,0.8)',
                      boxShadow: 'inset 0 1px 2px rgba(0,0,0,0.03)',
                  ...
                  <motion.button
                    ...
                    className="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-slate-600 focus:outline-none focus:text-emerald-500"
              ...
              <div className="flex items-center py-1.5 relative z-10">
                ...
                >
                  <motion.div
                    ...
                    animate={{
                      backgroundColor: rememberMe ? 'rgb(5,150,105)' : 'rgb(255,255,255)',
                      borderColor: rememberMe ? 'rgb(5,150,105)' : 'rgb(203,213,225)',
                    }}
            ...
            {/* Register link */}
            <div className="mt-8 pt-5 border-t border-slate-100/80 text-center relative z-10">
              <span className="text-[13px] font-medium text-slate-500">Don't have an account? </span>
              <button
                onClick={onNavigateToRegister}
                aria-label="Register for a new account"
                className="text-[13px] font-bold text-emerald-600 hover:text-emerald-700 focus:outline-none focus:underline relative group/reg"
              >
                Register Now
                <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-emerald-600 group-hover/reg:w-full transition-all duration-300" />
              </button>
            </div>
          </div>
        </motion.div>
